...
### Instrukcja obsługi
Interakcja z użytkownikiem odbywa się przez plik menu.bat. Po uruchomieniu skryptu, 
na ekranie użytkownika pojawia się proste menu z możliwością wyboru jednej z czterech opcji, wybieranej poprzez naciśnięcie cyfry jej odpowiadającej, a następnie klawisza Enter:
1.	Uruchom program
2.	Wyświetl opis 
3.	Utwórz backup
4.	Wyjście
